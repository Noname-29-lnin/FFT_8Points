...
\NameGroup{08}
\NameLesson[\Large]{BIG PROJECT 2 REPORT}
\NameTitle[\Huge]{FPGA Implementation of 8-Point FFT - Digital System Design}
...
\include{./my-chapters/RTL_design.tex}
\include{./my-chapters/Verification.tex}
\include{./my-chapters/synth.tex}

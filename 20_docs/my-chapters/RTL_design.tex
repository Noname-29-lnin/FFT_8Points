...
\begin{figure}[H]
	\centering
		\includegraphics[height=\linewidth, scale=0.5]{./my-chapters/my-images/DesignRTL_FFT/FPU_ADD_SUB/Flowchart_for_FPU_ADD_SUB.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\linewidth]{./my-chapters/my-images/DesignRTL_FFT/FPU_ADD_SUB/BlockDiagram_Overview.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[height=\linewidth, scale=0.5]{./my-chapters/my-images/DesignRTL_FFT/FPU_MUL/Flowchart_for_FPU_MUL.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\linewidth]{./my-chapters/my-images/DesignRTL_FFT/FPU_MUL/BlockDiagram_Overview.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\linewidth]{./my-chapters/my-images/DesignRTL_FFT/BPU/Butterfly_unit.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\linewidth]{./my-chapters/my-images/DesignRTL_FFT/BPU/FFT_8Point.png}
...
\begin{enumerate}[label=\arabic*.]
	\item Ở tầng 1:
		\begin{figure}[H]
			\centering
			\includegraphics[width=.6\linewidth]{./my-chapters/my-images/DesignRTL_FFT/FFT_cus_BF2.png}
		\end{figure}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=.7\linewidth]{./my-chapters/my-images/DesignRTL_FFT/BPU/BFP_2.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=.6\linewidth]{./my-chapters/my-images/DesignRTL_FFT/FFT_cus_BF4.png}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{./my-chapters/my-images/DesignRTL_FFT/BPU/BFP_4.png}
		\caption{Bộ BFP ở tầng 2 của bộ FFT.}
	\end{figure}
	
	\item Ở tầng 3:
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\linewidth]{./my-chapters/my-images/DesignRTL_FFT/FFT_cus_BF8.png}
	\end{figure}
	
	Các Butterfly cần xử lý hai giá trị của Twddile là $W^{0}_{8} = 1$ và $W^{1}_{8} = 0.7071 - j0.7071$, $W^{2}_{8} = -j$, $W^{3}_{8} = -0.7071 - j0.7071$. Với giá trị $W^{0}_{8} = 1$ và $W^{2}_{8} = -j$ xử lý tương tự với ở tầng 2, các giá trị $W^{1}_{8}$ và $W^{3}_{8}$ ta cần thêm một bộ để xử lý phép toán nhân với giá trị $\sqrt2$:
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.5\linewidth]{./my-chapters/my-images/DesignRTL_FFT/BPU/Complex_multiplier.png}
		\caption{Bộ Complex Multiplier.}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\linewidth]{./my-chapters/my-images/DesignRTL_FFT/BPU/BFP_8.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\linewidth]{./my-chapters/my-images/DesignRTL_FFT/BPU/FFT_8Point_cus.png}
	\caption{Thiết kế của bộ FFT-8Point sau khi tối ưu hóa.}
\end{figure}

Với số lượng bộ cộng, trừ, nhân floating như sau:

\begin{itemize}
	\item Bộ cộng/trừ: 44 bộ.
	\item Bộ nhân: 2 bộ.
\end{itemize}